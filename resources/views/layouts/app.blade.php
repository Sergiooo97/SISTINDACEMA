    ...
    <div id="app">
        <div class="wrapper ">
            ...
            -->
              ...
              <div class="sidebar-wrapper">
                <ul class="nav">
                  ...
                  <li class="{{request()->is('personal/i') ? 'active' : '' }} 
                  {{request()->is('personal/c?id=00000') ? 'active' : '' }}
                  {{request()->is('personal/*/detalles') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('personal.index')}}">
                      <i class="material-icons">person</i>
                      <p>Información personal</p>
                    </a>
                  </li>
                  <li class="{{request()->is('historial-laboral/i') ? 'active' : '' }} {{request()->is('historial-laboral/c') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('historial-laboral.index')}}">
                      <i class="material-icons">content_paste</i>
                      <p>Historial laboral</p>
                    </a>
                  </li>
                  <li class="{{request()->is('prestamos/i') ? 'active' : '' }} {{request()->is('prestamos/c') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('prestamos.index')}}">
                      <i class="material-icons">attach_money</i>
                      <p>Prestamos</p>
                    </a>
                  </li>
                  <li class="{{request()->is('vacaciones/i') ? 'active' : '' }} {{request()->is('vacaciones/c') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('vacaciones.index')}}">
            ...
            <div class="main-panel">
              ...
              <!-- End Navbar -->
              <div style="padding: 3em!important;" class="">
                <main style="padding: 5px!important;" class="py-4">
                    @yield('content')
                </main>
              </div>
              <footer class="footer">
                <div class="container-fluid">
                  ...
                  <div class="copyright float-right">
                    ...
                    <a href="https://www.creative-tim.com" target="_blank">Juan Aban | Tec Motul</a>.
                  </div>
                </div>
              </footer>
            </div>
          ...
          <script src="{{ asset('js/material-dashboard.js?v=2.1.2') }}" defer></script>
